...
This branch is built to be compatible with Alfresco 4.2. It may be used on either Community or Enterprise Edition. Separate branches exist for compatibility versions targeting Alfresco [5.2 and above](https://github.com/Acosix/alfresco-simple-content-stores/tree/master) and [5.0/5.1](https://github.com/Acosix/alfresco-simple-content-stores/tree/alfresco-5.0).
...
<!-- JAR packaging -->
<dependency>
    <groupId>de.acosix.alfresco.simplecontentstores-42</groupId>
