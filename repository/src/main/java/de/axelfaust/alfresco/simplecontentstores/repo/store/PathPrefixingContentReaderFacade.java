 ...
 * @author Axel Faust
 */
public class PathPrefixingContentReaderFacade extends BaseContentReaderFacade
{
    ...
    public PathPrefixingContentReaderFacade(final ContentReader delegate, final String pathPrefix)
    {
        super(delegate);
